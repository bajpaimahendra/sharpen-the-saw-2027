let add,subtract,msg;_4e5‍.w("./utils/esm-cal-2",[["add",["add"],function(v){add=v}],["subtract",["subtract"],function(v){subtract=v}],["msg",["msg"],function(v){msg=v}]]);/*
...
_4e5‍.g.console.log('sum1 = ', sum1);
_4e5‍.g.console.log('difference1 = ', difference1);
_4e5‍.g.console.log('msg = ', msg);
_4e5‍.g.console.log('msg = ', months);  // months is default export by esm-cal-2, and consume here as variable rather than object
